(function($) {
    ...
    $.fn.pbTouchSlider = function(options) {
        ...
        pbSlider.slider_NavArrows ='<ul class="o-slider-arrows"><li  class="o-slider-prev"><img src="images/prev1.png"></li><li class="o-slider-next"><img src="images/next1.png"></li></ul>';
