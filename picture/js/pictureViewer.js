;(function ($, document, window) {
    $.pictureViewer = function (options) {
        var pictureViewer_html =    '<div id="pictureViewer">' +
                                    ...
                                    '<video autoplay class="cover cover1" src=""></video>' +
                                    '<img class="cover cover2" src="">' +
                                    '</div>' +
        ...
        console.log(pictureViewer_html);
        //init dom
        ...
        var changeImage = function changeImage(index) {
            if(index>0){
                $(".cover1").remove();
                $(".cover2").remove();
                $('.picture-content').prepend('<img class="cover cover2" src="'+$images[index]+'">');
                console.log(1);
            }else{
                $(".cover1").remove();
                $(".cover2").remove();
                $('.picture-content').prepend('<video autoplay class="cover cover1" src="'+$images[index]+'"></video>');
                console.log(2);
            }
